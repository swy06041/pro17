...
<body>
	...
	<form method="post"
		action="${contextPath}/member/modMember.do?userId=${memInfo.userId}">
		<table align="center">
			<tr>
				<td width="200"><p align="right">아이디</td>
				<td width="400"><input type="text" name="userId"
					value="${memInfo.userId}" disabled></td>

			</tr>
			<tr>
				<td width="200"><p align="right">비밀번호</td>
				<td width="400"><input type="password" name="userPass"
					value="${memInfo.userPass}"></td>
			</tr>
			<tr>
				<td width="200"><p align="right">이름</td>
				<td width="400"><input type="text" name="userName"
					value="${memInfo.userName}"></td>
			</tr>
			<tr>
				<td width="200"><p align="right">이메일</td>
				<td width="400"><input type="text" name="userEmail"
					value="${memInfo.userEmail}"></td>
			</tr>
			<tr>
